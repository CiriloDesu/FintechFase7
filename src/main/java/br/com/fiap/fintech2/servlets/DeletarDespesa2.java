...
@WebServlet("/deletarDespesa2")
public class DeletarDespesa2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id != null && !id.isEmpty()) {
            ...
            int id_user = (request.getSession().getAttribute("ID_USER") != null)
                    ? ((Integer) request.getSession().getAttribute("ID_USER")).intValue()
                    : 0;
            ...
            if (usuario != null) {
                ...
                Alert alert = new Alert("Realizar login", "info");
